...
export function EventFooter() {
  return (
    <footer className="bg-[#090909] text-[#CFC9B8] border-t border-[#2E2B25]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start mb-12">
          {/* Brand & Mission column */}
          <div className="md:col-span-6 space-y-3">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#1A1A1A] to-[#E8A020] text-[#0D0D0D] font-black flex items-center justify-center">
            ...
            <p className="text-xs sm:text-sm text-[#CFC9B8] max-w-md leading-relaxed">
            ...
            <div className="flex items-center gap-2 text-xs text-[#CFC9B8] pt-2">
              <Building className="w-4 h-4 text-[#E8A020]" />
            ...
            <div className="flex items-center gap-2 text-xs text-[#CFC9B8]">
              <MapPin className="w-4 h-4 text-[#E8A020] shrink-0" />
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-2.5 text-xs">
              {eventContent.support.legalLinks.map((item, idx) => (
                <li key={idx}>
                  <a href={item.href} className="hover:text-[#E8A020] transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
        ...
        {/* Copyright Bar */}
        <div className="pt-8 border-t border-[#1C1A17] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#A89F91]">
          <p>
