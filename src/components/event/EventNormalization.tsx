      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center pt-4">
          <Button
            ...
            className="h-14 px-8 bg-[#0D0D0D] hover:bg-[#1A1A1A] text-[#F2EFE6] font-extrabold rounded-xl uppercase tracking-wider text-sm shadow-lg shadow-black/20 hover:scale-[1.02] active:scale-[0.98] transition-all inline-flex items-center gap-2 border border-[#2E2B25]"
          >
            <span>Quero Mudar Esse Ciclo na Imersão</span>
            <ArrowRight className="w-4 h-4 text-[#E8A020]" />
          </Button>
        </div>
      </div>
    </section>
