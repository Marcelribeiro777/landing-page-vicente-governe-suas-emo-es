      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center w-full pt-4">
          <Button
            ...
            className="relative overflow-hidden w-full sm:w-auto max-w-full min-h-[3.5rem] sm:h-16 px-4 py-3 sm:px-10 bg-gradient-to-r from-[#E8A020] via-[#F5B83D] to-[#E8A020] hover:from-[#F5B83D] hover:to-[#E8A020] text-[#0D0D0D] font-black rounded-xl uppercase tracking-wider text-xs sm:text-base shadow-[0_0_25px_rgba(232,160,32,0.35)] hover:shadow-[0_0_35px_rgba(245,184,61,0.55)] hover:scale-[1.03] active:scale-[0.98] transition-all inline-flex items-center justify-center gap-2 border-2 border-[#F5B83D] whitespace-normal text-center"
          >
